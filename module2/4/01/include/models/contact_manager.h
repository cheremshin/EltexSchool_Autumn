...
/**
 * @brief Структура, представляющая из себя узел двухсвязного списка контактов
 * 
 */
...
typedef struct ContactManager {
    ContactNode *head; ///< Первый элемент списка
    ContactNode *tail; ///< Последний элемент списка
